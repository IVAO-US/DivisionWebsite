                    ...
                    <x-card class="flex flex-col h-full">
                        @if($this->hasTours)
                            <div class="flex-1">
                                ...
                                <livewire:bento-grid :images="$this->getToursData()" setup-id="{{ $bentoSetupId }}" wire:key="mobile-tours" />
                            </div>
            ...
            <div class="lg:col-span-2 flex flex-col">
                <x-card title="Tours" subtitle="Discover Amazing Flight Routes" shadow separator class="flex flex-col flex-1">
                    @if($this->hasTours)
                        <div class="flex-1">
                            {{-- Bento Grid for Tours --}}
                            <livewire:bento-grid :images="$this->getToursData()" wire:key="desktop-tours" setup-id="{{ $bentoSetupId }}" />
                        </div>
